...
def load_bn_ggn(adj_filepath, ts_filepath, batch_size = 128,dyn_type='table'):

    # address
    series_address = './data/bn/mark-27022-adjmat.pickle'
    adj_address = './data/bn/mark-27022-series.pickle'
    series_address = adj_filepath # actually adj    
    adj_address = ts_filepath  # actually time series data
