...
def load_voter(batch_size=128,node_num=100,network='ER',exp_id=1, modelname='invvoter'):

    #data path
    series_path = './data/voter_'.replace('voter',modelname) + network + '_' + str(node_num) + '_id' + str(exp_id) + '_data.pickle'
    adj_path = './data/voter_'.replace('voter',modelname) + network + '_' + str(node_num) + '_id' + str(exp_id) + '_adj.pickle'
